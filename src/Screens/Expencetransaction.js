    ...
    <ImageBackground style={{ height: 287, width: 414 }} source={require('../assets/images/homepaged.png')}>
        ...
        <View style={{ height: 731, width: 395, backgroundColor: 'white', borderRadius: 40, top: -80 }}>
            ...
            <View style={{justifyContent:'center',alignItems:'center',top:25}}>
                <Image style={{height:80,width:80,borderRadius:40}} source={require('../assets/images/userone.png')}></Image>
                <Image style={{width:80,height:25,top:12}} source={require('../assets/images/expenselogo.png')}></Image>
                <Text style={{fontSize:24,color:'black',fontWeight:'600',top:16}}>$ 85.00</Text>
            </View>
            ...
            <View style={{flexDirection:'row',justifyContent:'space-between',paddingHorizontal:20,top:70}}>
                <View>
                    ...
                    <Text style={styles.detailone}>To</Text>
                    <Text style={styles.detailone}>Time</Text>
                    <Text style={styles.detailone}>Date</Text>
                    
                </View>
                <View>
                    <Text style={{fontSize:16,color:'#F95B51',top:12,textAlign:'right'}}>Expense</Text>
                    <Text style={styles.detailtwo}>Claire Jovalski</Text>
            ...
            <View style={{flexDirection:'row',justifyContent:'space-between',paddingHorizontal:20,top:80}}>
                <View>
                    ...
                    <Text style={styles.detailone}>Spending</Text>
