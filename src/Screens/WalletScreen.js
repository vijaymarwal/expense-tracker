...
<View style={{height:731,width:395,backgroundColor:'white',borderRadius:40,top:-80}}>
  ...
  <View style={{height:48,width:354,backgroundColor:'#F4F7F6',left:20,top:120,borderRadius:40,justifyContent:'center',flexDirection:'row'}}>
    ...
    <TouchableOpacity style={{width:170,height:40,backgroundColor:'white',borderRadius:40,justifyContent:'center',alignItems:'center',top:4}}>
      <Text style={{color:'black'}}>Transactions</Text>
    </TouchableOpacity>

    <TouchableOpacity style={{width:170,height:40,borderRadius:40,left:5,justifyContent:'center',alignItems:'center',top:4 }} >
...
data={[
  ...
  {id:1,key:'vijay',vijay:require('../assets/images/upworklogo.png'),time:'Today',transactiondetailplus:'+$ 850.00'},
